...
export default class ProjectSettingUser extends React.Component {
    ...
    callbackAddDeleteMember(userNo, userName, userPhoto, userGrade) {
        this.props.callbackProjectSetting.addDeleteMember(userNo, userName, userPhoto, this.props.project.projectNo, userGrade);
    }

    render() {
        return (
            <div className="invite-card-member" key={this.props.user.userNo}
                id={this.props.user.userNo} onClick={this.callbackAddDeleteMember.bind(this, this.props.user.userNo, this.props.user.userName, this.props.user.userPhoto, this.props.user.userGrade)}>
