                            ...
                            <li className="taskSettingList">
                                ...
                                <div style={{ display: 'inline-block' }}>
                                    <div className="dateBtn">
                                        ...
                                        <Button variant="" onClick={this.props.taskCallbacks.modalStateUpdate} disabled={taskItem.taskState == "del" || authUserRole != 1 ? true: false} > 
                                        <i className="fas fa-plus fa-1x"></i>
                                        </Button>}
                                        {taskItem.taskStart && !taskItem.taskEnd &&
                                         <Button variant="" onClick={this.props.taskCallbacks.modalStateUpdate} disabled={taskItem.taskState == "del" || authUserRole != 1 ? true: false} className="dateButtom"> 
